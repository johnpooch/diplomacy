# Generated by Django 2.2.5 on 2019-11-23 14:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('awaiting participants', 'Awaiting Participants'), ('pending', 'Pending'), ('live', 'Live'), ('ended', 'Ended')], default='awaiting participants', max_length=22)),
                ...
                ('country_choice_mode', models.CharField(choices=[('random', 'Random'), ('preference', 'Preference'), ('first come', 'First come first serve')], default='random', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('turn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='territorystate_states', to='core.Turn')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nation_state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pieces', to='core.NationState')),
                ...
                ('turn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='piece_states', to='core.Turn')),
            ],
            options={
                'db_table': 'piece',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome', models.CharField(choices=[('resolved', 'Resolved'), ('bounced', 'Bounced'), ('illegal', 'Illegal'), ('aux failed', 'Aux failed'), ('aux does not correspond', 'Aux does not correspond')], max_length=25, null=True)),
                ('aux', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.Territory')),
                ('nation_state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='core.NationState')),
