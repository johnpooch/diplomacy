...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('persisted_piece_id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='This ID is persisted across `Piece` instances which belong to the same in game piece.')),
                ...
                ('attacker_territory', models.ForeignKey(help_text="If the piece was dislodged via a land attack, the piece cannot to the attacking piece's territory.", null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Territory')),
